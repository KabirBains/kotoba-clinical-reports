    ...
    items: [
      {
        ...
        consequence: "self-neglect, deterioration in skin integrity, nutritional compromise, and increased falls risk during unsupervised personal care tasks",
        sections: ["12.3"],
      },
      {
        id: "domestic",
        ...
        consequence: "deterioration of the home environment, nutritional compromise due to inability to prepare meals, and increased burden on informal supports",
        sections: ["12.4"],
      },
      {
        id: "community_access",
        ...
        consequence: "increased social isolation, inability to attend medical appointments, and progressive withdrawal from community life",
        sections: ["9", "12.8"],
      },
      {
        id: "overnight_active",
        ...
        consequence: "unmanaged safety risks overnight, risk of falls without assistance, and unsustainable burden on informal overnight supports",
        sections: ["11", "12.2"],
      },
      {
        ...
        consequence: "participant left without overnight safety net, increasing risk of harm from unmanaged medical or behavioural events",
        sections: ["11"],
      },
      {
        ...
        consequence: "choking incidents during unsupervised mealtimes, nutritional compromise, and risk of aspiration-related hospitalisation",
        sections: ["12.3"],
      },
      {
        id: "transport",
        ...
        consequence: "inability to attend medical appointments, allied health sessions, and community activities, leading to functional decline and social isolation",
        sections: ["12.5"],
      },
      {
        ...
        outcomes: ["maintain_safety", "reduce_informal"],
        consequence: "deterioration of the home environment, safety hazards from unmaintained outdoor areas, and increased burden on informal supports",
        sections: ["12.4"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        consequence: "compromised dignity, skin integrity issues, and increased personal care time",
        sections: ["12.3"],
        isConsumable: true,
      },
      {
        ...
        consequence: "increased falls risk, reduced independence in ADLs, and higher support worker hours required for tasks the participant could complete with appropriate equipment",
    ...
    items: [
      {
        ...
        consequence: "missed opportunity for capacity building intervention that could reduce long-term support needs, and inability to assess and implement appropriate assistive technology and home modifications",
      ...
      },
      {
        ...
        consequence: "progressive decline in mobility, increased falls risk, and deconditioning that will increase long-term support needs",
        sections: ["12.1", "12.2"],
      },
      {
        id: "psychology",
        ...
        consequence: "unmanaged mental health symptoms, risk of acute deterioration and hospitalisation, and inability to engage meaningfully with other supports",
        sections: ["11", "12.8"],
      },
      {
        id: "speech",
        ...
        consequence: "unmanaged swallowing risks, inability to communicate needs effectively, and progressive social withdrawal due to communication barriers",
        sections: ["12.7"],
      },
      {
        id: "dietitian",
        ...
        consequence: "nutritional compromise, weight-related health complications, and increased risk of hospital presentation for malnutrition-related conditions",
        sections: ["12.3"],
      },
      {
        ...
        consequence: "progressive deconditioning, increased falls risk, and reduced capacity for independent daily living tasks",
        sections: ["12.1"],
      },
      {
        ...
        consequence: "escalation of behaviours of concern, risk of harm to self or others, potential for increased use of restrictive practices, and placement breakdown",
        sections: ["11", "12.8"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        consequence: "fragmented service delivery, inability to implement the NDIS plan effectively, and increased burden on informal supports to coordinate care",
        sections: [],
      },
      {
        id: "specialist_sc",
        ...
        consequence: "uncoordinated complex support needs, increased risk of crisis presentation, and potential placement breakdown",
        sections: ["11"],
      },
      {
        ...
        outcomes: ["social_participation", "build_capacity", "achieve_goals"],
        consequence: "ongoing social isolation, lack of meaningful daytime activity, and missed opportunities for skill development and social connection",
        sections: ["9", "10"],
      },
      {
        ...
        consequence: "child safety concerns, inability to meet parenting responsibilities independently, and risk of child protection involvement",
        sections: ["12.5"],
      },
      {
        ...
        consequence: "inability to pursue employment or educational goals, continued financial dependence, and missed opportunity for meaningful occupation",
        sections: ["12.5", "12.6"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        consequence: "ongoing falls risk in unsafe home environment, inability to access essential areas of the home independently, and potential need for premature residential placement",
        sections: ["8"],
        isCapital: true,
      },
      {
        ...
        outcomes: ["build_capacity", "maintain_safety", "social_participation"],
        consequence: "inability to mobilise independently, progressive postural deterioration, pressure injury risk, and reduced community participation",
        sections: ["12.1", "12.7"],
        isCapital: true,
      },
    ],
